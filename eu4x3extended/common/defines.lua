...
NReligion = {
	...
	PIETY_CORRUPTION = -6,	--X3 Mod
	PIETY_MANPOWER = 6.0,	--X3 Mod
	PIETY_COST = 0.50,
...
NGovernment = {
	...
	RUSSIAN_ABILITY_SUDEBNIK_AUTONOMY_CHANGE = -30,
	...
	RUSSIAN_ABILITY_OPRICHNINA_CHANGE = -0.9,
	RUSSIAN_ABILITY_STRELTSY_WE_CHANGE = -6,
	RUSSIAN_ABILITY_STRELTSY_SPAWN_SIZE = 0.6,
